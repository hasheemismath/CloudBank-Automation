...
public class CAHomePage extends UIActions {
    ...
    By newApplicationLink = By.xpath("//*[@id=\"mainNav\"]/li[4]/a");
    ...
    public void validateNewApplicationURL(){
        Assert.assertTrue(driver.findElement(newApplicationLink).isDisplayed(), "New Application Link is not displayed!!!");
    }
