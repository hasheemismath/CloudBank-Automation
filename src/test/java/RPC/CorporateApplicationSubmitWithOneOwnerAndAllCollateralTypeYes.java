...
public class CorporateApplicationSubmitWithOneOwnerAndAllCollateralTypeYes {
    ...
    public void testNavigateToCollateralSection() throws Exception {
        propertyFileReader = new PropertyFileReader();
        String positiveBusinessData1 = propertyFileReader.getProperty("config", "positiveOwnershipData1");
        CSVReadWrite csvReadWrite = new CSVReadWrite();
        CSVReader csvReader = csvReadWrite.readfile(positiveBusinessData1);
        String [] line;
        while ((line = csvReader.readNext()) != null) {
    ...
    public void testNavigateToPersonalDocumentsSection() {
        ...
        collateralPage.selectYesInVehiclePurchased();
        collateralPage.selectYesInVehicleOwned();
        collateralPage.selectYesInCertifiedOfDeposit();
        collateralPage.selectYesInBusinessInsuranceInformation();
        collateralPage.selectYesInJewelery();
        collateralPage.selectYesInOther();
    ...
    public void testNavigateToOtherDocumentsSection() throws AWTException {
        ...
        collateralDocumentsPage.forthTabDocumentUpload();
        collateralDocumentsPage.fifthTabDocumentUpload();
        collateralDocumentsPage.sixthTabDocumentUpload();
        collateralDocumentsPage.seventhTabDocumentUpload();
        collateralDocumentsPage.eigthTabDocumentUpload();
        collateralDocumentsPage.ninethTabDocumentUpload();
