...
public class AutoDecisionDeclinedScenario {
    ...
    public void testLoginWithAnExistingBorrower()  {
        borrowerHomePage = loginPage.successfulBorrowerLogin("robertrhutchinson8+150@gmail.com", "Qwerty1!");
    }
    ...
    public void testFillCorrectPersonalDetails() throws Exception {
        ...
        validations.validateLogedUser("VANESSA LACEY");
        String declineDataSet = propertyFileReader.getProperty("JSFconfig", "declineDataSet");
        CSVReadWrite csvReadWrite = new CSVReadWrite();
        CSVReader csvReader = csvReadWrite.readfile(declineDataSet);
        String [] line;
