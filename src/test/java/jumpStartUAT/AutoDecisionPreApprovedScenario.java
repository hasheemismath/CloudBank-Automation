...
public class AutoDecisionPreApprovedScenario {
    ...
    public void testLoginWithAnExistingBorrower()  {
        borrowerHomePage = loginPage.successfulBorrowerLogin("robertrhutchinson8+90@gmail.com", "Qwerty1!");
    }
    ...
    public void testFillCorrectPersonalDetails() throws Exception {
        ...
        validations.validateLogedUser("Robert Uphold");
        String preApprovedDataSet = propertyFileReader.getProperty("JSFconfig", "preApprovedDataSet");
        CSVReadWrite csvReadWrite = new CSVReadWrite();
        CSVReader csvReader = csvReadWrite.readfile(preApprovedDataSet);
        String [] line;
...
//    }
    ...
    public void testAutoDecisionStatus(){
        autoDecisionPage = new AutoDecisionPage();
        autoDecisionPage. validateAutoDecisionStatus("PRE APPROVED");
    }
